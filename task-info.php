...
$sql = "SELECT task_id, t_email, t_end_time, t_description FROM task_info
        ORDER BY task_id";
      ...
      while($row = $info->fetch(PDO::FETCH_ASSOC)){
        ...
        if ($t_email == true) {
          ...
          <br>Please log in  @<strong>$msg</strong>   <a href='https://workflow-application.herokuapp.com/index.php' target='_blank'>here</a> 
              ...
              <div class="form-horizontal">
                <div class="form-group">
                  ...
                  <option value="">Select Project...</option>    
    						<option value="JoburgWater">Joburg Water</option>
    						<option value="RandRefinery">Rand Refinery</option>
   							<option value="Cheita">Cheita</option>
    						<option value="SuperApps">Super Apps</option>
							<option value="ERP">ERP</option>
    						<option value="HealthMBA">Health MBA</option>
   							<option value="HealthHopkins">Health Hopkins</option>
                ...
                <div class="col-sm-7">
                  <input type="text" name="t_subtask" placeholder="Text Task" id="t_subtask" list="expense" id="default" class="form-control" <?php if($user_role != 1){ ?> readonly <?php } ?> val required>
                  </div>
                </div>
