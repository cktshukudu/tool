...
4. click **'Ctrl + F'** and search for **'80'** and replace it with **'8080'** and then save and close.

5. start Apache and MySQL (make sure they are both highlighted with <ins>**green**</ins> once started).

6. go to your browser and paste this link `http://localhost:8080/phpmyadmin/`.
...
10. lastly, paste this link on your browser `http://localhost:8080/workflow-app/` and you are DONE !!  :smiley:
